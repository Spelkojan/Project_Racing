...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAIControl : MonoBehaviour
    {
        ...
        private CarControllerAI mCarControllerAI;    // Reference to actual car controller we are controlling
        ...
        private void Awake()
        {
            ...
            mCarControllerAI = GetComponent<CarControllerAI>();
        ...
        private void FixedUpdate()
        {
            if (m_Target == null || !m_Driving)
            {
                ...
                mCarControllerAI.Move(0, 0, -1f, 1f);
            }
            else
            {
                Vector3 fwd = transform.forward;
                if (m_Rigidbody.velocity.magnitude > mCarControllerAI.MaxSpeed*0.1f)
                {
                    fwd = m_Rigidbody.velocity;
                }

                float desiredSpeed = mCarControllerAI.MaxSpeed;
                    ...
                    case BrakeCondition.TargetDirectionDifference:
                        {
                            ...
                            desiredSpeed = Mathf.Lerp(mCarControllerAI.MaxSpeed, mCarControllerAI.MaxSpeed*m_CautiousSpeedFactor,
                ...
                float accelBrakeSensitivity = (desiredSpeed < mCarControllerAI.CurrentSpeed)
                                                  ? m_BrakeSensitivity
                                                  : m_AccelSensitivity;

                // decide the actual amount of accel/brake input to achieve desired speed.
                float accel = Mathf.Clamp((desiredSpeed - mCarControllerAI.CurrentSpeed)*accelBrakeSensitivity, -1, 1);
                ...
                float steer = Mathf.Clamp(targetAngle*m_SteerSensitivity, -1, 1)*Mathf.Sign(mCarControllerAI.CurrentSpeed);

                // feed input to the car controller.
                mCarControllerAI.Move(steer, accel, accel, 0f);
